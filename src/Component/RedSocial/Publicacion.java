...
public class Publicacion {
    ...
    public static void registro(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            new Notification().send_url("TlleBo",
                    "" + usuario_.getString("Nombres") + " " + usuario_.getString("Apellidos") + " publicó, "
                            + publicacion.getString("descripcion"),
                    "https://tllebo.servisofts.com/images/publicacion/" + publicacion.getString("key"),
                    "tllebo.servisofts.com://app/publicacion/post?pk=" + publicacion.getString("key"));
