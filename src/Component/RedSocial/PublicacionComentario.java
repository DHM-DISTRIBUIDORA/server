...
public class PublicacionComentario {
    ...
    public static void registro(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            new Notification().send("TlleBo", ""+usuario_.getString("Nombres")+" "+usuario_.getString("Apellidos")+" comentó tu publicación.", "https://tllebo.servisofts.com/images/usuario/"+obj.getString("key_usuario"), "tllebo.servisofts.com://app/publicacion/post?pk="+publicacion.getString("key"), publicacion.getString("key_usuario"));
