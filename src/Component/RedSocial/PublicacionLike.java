...
public class PublicacionLike {
    ...
    public static JSONObject getLike(String key_publicacion, String key_usuario) throws Exception{
        String consulta = "select public.get_by('publicacion_like', 'key_usuario', '"+key_usuario+"', 'key_publicacion', '"+key_publicacion+"') as json";
    ...
    public static void registro(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            new Notification().send("TlleBo", ""+usuario_.getString("Nombres")+" "+usuario_.getString("Apellidos")+" le dió un like a tu publicación.", "https://tllebo.servisofts.com/images/usuario/"+obj.getString("key_usuario"),"tllebo.servisofts.com://app/publicacion/post?pk="+publicacion.getString("key"),publicacion.getString("key_usuario"));
